    ...
    def clean(self):
        ...
        if User.objects.filter(username=username).exists():
            raise forms.ValidationError(
                "A user with this login is already registered in the system!"
            )
...
class OrderForm(forms.Form):
    ...
    NameonCard = forms.CharField(
        required=True, widget=forms.TextInput(attrs={"placeholder": "Name Surname"})
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["expiry_date"].widget.attrs[
            "class"
        ] = "btn  dropdown-toggle dropdown-toggle-split center"
        ...
        self.fields[
            ...
            "Please indicate the real phone number by which you can be contacted"
        )
        ...
        self.fields[
            "date"
        ].help_text = "Delivery is made on the next day after placing the order. The manager will contact you first! "
